    ...
    <q-layout view="hHh lpR fFf">
        ...
        >
            ...
            <q-tabs align="left">
                ...
                <q-route-tab to="/personal" label="Personal" />
                <q-route-tab to="/empresas" label="Empresas" />
                <q-route-tab to="/cargos" label="Cargos" />
                <q-route-tab to="/postulaciones" label="Postulaciones" />
                <q-route-tab>
                    <a
                        class="link"
        ...
        <q-footer reveal elevated class="footer">
            <small>
                <div align="center">
                    <strong
                        >Copyright &copy; 2022
                        <a href="/">FAST TRACK TALENT</a>.</strong
                    >
